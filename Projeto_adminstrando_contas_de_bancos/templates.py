...
class UI:
    ...
    def _desativar_conta(self):
        ...
        try:
            ...
            print('Essa conta ainda possui saldo, faça uma tranferência')
    ...
    def _transferir_saldo(self):
        ...
        conta_retirar_id = int(input('Qual conta retirar? '))
        ...
        tranferir_saldo(conta_retirar_id, conta_enviar_id, valor)
