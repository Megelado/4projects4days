...
def main(page: ft.Page):
    ...
    create_button = ft.ElevatedButton(text="Criar Aluno", on_click=ciar_aluno_click)
    ...
    students_table = ft.DataTable(
        columns=[
            ...
            ft.DataColumn(ft.Text('Data_Nascimento')),
        ],
        rows=[]
)
    ...
    def listar_alunos_click(e):
        ...
        list_result.value = f"{len(alunos)}"
        page.update()
    ...
    def consultar_progresso_click(e):
        ...
        if response.status_code == 200:
            ...
            progress_result.value = (
                ...
                f"Aulas necessarias para a próxima faixa: {progress.get('aulas_necessarias_para_proxima_faixa')}\n"
            )
        else:
    ...
    tabs = ft.Tabs(
        ...
        tabs=[
            ...
            ft.Tab(text="Consultar progresso do aluno", content=progress_tab),
